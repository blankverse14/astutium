...
var selections = ["www.sdddddasdasdsad.com-1 Year: £6.99", "www.sdddddasdasdsad.org-1 Year: £6.99",
 "www.sdddddasdasdsad.net-1 Year: £6.99", "www.sdddddasdasdsad.biz-1 Year: £6.99", "www.sdddddasdasdsad.info-1 Year: £6.99"]
var prev;
var count = 0;
var newOld;
var welcome;
...
$('input[name=custType]').click(function(){
	...
	if(newOld === "exist"){
		...
		$('.customerChoice').append("<div id='append'><label class='login'>Email Adress:<label><input class='loginText1' type='text' name='email'><br/>"+
			"<label class='login'>Password:</label><input class='loginText2' type='password' name='pass'></div><br>");
		count=4;
